            <div class="container-fluid">
                ...
                <ol class="breadcrumb text-size">
                    <li class="breadcrumb-item"><a href="#"><span>Perjalanan Dinas</span></a></li>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-primary font-weight-bold text-xs mb-1">
                                            <h5><strong>PERJ. DINAS ANGGOTA DPRD</strong></h5>
                                        </div>
                                        <div class="text-primary font-weight-bold h5 mb-0"><span><strong><?php echo count($dinas_dprd); ?>  Surat Tugas</strong><br></span></div>
                                    </div>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1">
                                            <h5><strong>PERJ. DINAS ANGGOTA SETWAN</strong></h5>
                                        </div>
                                        <div class="text-success font-weight-bold h5 mb-0"><span><strong><?php echo count($dinas_setwan); ?> Surat Tugas</strong><br></span></div>
                                    </div>
                        ...
                        <div class="card shadow border-left-primary py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-primary font-weight-bold text-xs mb-1">
                                            <h5><strong>PERJ. DINAS DARAT</strong></h5>
                                        </div>
                                        <div class="text-primary font-weight-bold h5 mb-0"><span><strong><?php echo count($dinas_darat); ?>  Surat Tugas</strong><br></span></div>
                                    </div>
                                    <!--<div class="col-auto"><i class="fas fa-flag fa-2x text-primary"></i></div>-->
                                </div>
                            </div>
                        ...
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1">
                                            <h5><strong>PERJ. DINAS UDARA</strong></h5>
                                        </div>
                                        <div class="text-success font-weight-bold h5 mb-0"><span><strong><?php echo count($dinas_udara); ?> Surat Tugas</strong><br></span></div>
                                    </div>
                                    <!--<div class="col-auto"><i class="fas fa-flag fa-2x text-success"></i></div>-->
                                </div>
                            </div>
