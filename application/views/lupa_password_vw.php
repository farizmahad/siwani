...
<body class="bg-gradient-primary">
    <div class="container">
        <form method="POST" action="<?php echo base_url(); ?>Login/aksi_lupa_password" id="myform" onSubmit="return validasi()">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-2">Lupa Password?</h4>
                                        <p class="mb-4">Silakan isi email, tautan ganti password akan dikirimkan ke email anda!</p>
                                    </div>
                                        <div>
                                           <?php echo $this->session->flashdata('message');?>
                                       </div>

                                        <div class="form-group"><input class="form-control form-control-user" type="email" id="identity" aria-describedby="emailHelp" placeholder="Email" name="email"></div><button class="btn btn-primary btn-block text-white btn-user"
