        ...
        <nav class="navbar navbar-dark navbar-expand align-items-start visible sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" style="padding-top: 0px;" href="<?php echo base_url(); ?>Hasil_reses"><i class="fas fa-check-circle"></i><span class="text-size">Hasil Reses</span></a></li>
                ...
                <?php }elseif($rule="perjalanandinas" and $this->ion_auth->in_group($group2)){ ?>
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" style="padding-top: 0px;" href="<?php echo base_url(); ?>Perjalanan_dinas"><i class="fas fa-plane-departure"></i><span class="text-size">Perjalanan Dinas</span></a></li>
					<li class="nav-item" role="presentation"><a class="nav-link" style="padding-top: 0px;" href="master_data_dewan_old.html"><i class="fas fa-print"></i><span class="text-size">Cetak</span></a></li>
                <?php } ?>

                 

                 <?php
                      $group4=array('super admin','operator');
                    ?>
                     <?php if($this->ion_auth->in_group($group4)){ ?>

                    <li class="nav-item" role="presentation"><a class="nav-link" style="padding-top: 0px;" href="<?php echo base_url(); ?>master-data"><i class="fas fa-user-cog"></i><span class="text-size">Master Data</span></a></li>
                <?php } ?>
