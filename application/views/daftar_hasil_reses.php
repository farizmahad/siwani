<div class="container-fluid">
                <h4 class="text-dark mb-4"><strong>Daftar Hasil Reses</strong><br></h4>
                ...
                -->
                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>Proposal"><span><strong>Daftar Hasil Reses</strong></span></a></li>
                </ol>
                <div class="row">
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-primary font-weight-bold text-xs mb-1">
                                            <h5 class="text-size-heading"><strong>Hasil Reses 1</strong></h5>
                                        </div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span class="text-primary"><strong><?php echo count($reses1); ?> Usulan</strong><br></span></div>
                                    </div>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1">
                                            <h5><strong>Hasil Reses 2</strong></h5>
                                        </div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span class="text-success"><strong><?php echo count($reses2); ?> Usulan</strong><br></span></div>
                                    </div>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-danger font-weight-bold text-xs mb-1">
                                            <h5><strong>Hasil Reses 3</strong></h5>
                                        </div>
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-auto">
                                                <div class="text-dark font-weight-bold h5 mb-0 mr-3"><span class="text-danger"><strong><?php echo count($reses3); ?> Usulan</strong><br></span></div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-xl-3 mb-4">
                        <div class="card shadow border-left-primary py-2">
                            <div class="card-body">
								...
								<div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-right text-dark font-weight-bold h5 mb-0 p-1"><button class="btn btn-primary btn-sm text-size" type="button"  data-target="#result" id="pemerintahan" onClick="reply_click(this.id)">Lihat Daftar</button></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
								...
								<div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-right text-dark font-weight-bold h5 mb-0 p-1"><button class="btn btn-success btn-sm text-size" type="button"  data-target="#result" id="ekonomi" onClick="reply_click(this.id)">Lihat Daftar</button></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-xl-3 mb-4">
                        <div class="card shadow border-left-danger py-2">
                            <div class="card-body">
								...
								<div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-right text-dark font-weight-bold h5 mb-0 p-1"><button class="btn btn-danger btn-sm text-size" type="button"  data-target="#result" id="pembangunan" onClick="reply_click(this.id)">Lihat Daftar</button></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-xl-3 mb-4">
                        <div class="card shadow border-left-warning py-2">
                            <div class="card-body">
								...
								<div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-right text-dark font-weight-bold h5 mb-0 p-1"><button class="btn btn-warning btn-sm text-size" type="button"  data-target="#result" id="kesejahteraanrakyat" onClick="reply_click(this.id)">Lihat Daftar</button></div>
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  function reply_click(clicked_id)
            {
                ...
                $('#result').load("<?php echo base_url() ?>Proposal/reses_proposal/"+id+"/"+hasil);
            }  
</script>
