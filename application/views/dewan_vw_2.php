 ...
 <div class="card-header py-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-3 text-nowrap"><button class="btn btn-primary btn-sm text-size" type="button" data-toggle="modal" data-target="#addmodalDewan"><i class="fas fa-plus-circle"></i>&nbsp;Tambah Anggota Dewan</button></div>
                                                    ...
                                                    <div class="card shadow">
                                                        ...
                                                        <div class="card-body">
                                                         <div id="pesann"></div>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="col-xl-12">
                                                                        <div class="form-group"><label for="first_name"><strong>Nama Lengkap</strong></label><input class="form-control form-control-sm text-size" type="text" placeholder="Isi Gelar" name="nam_Lengkap" id="nama_lengkap"></div>
                                                                    </div>

                                                                    <div class="col">

                                                                    <label for="address"><strong>NIP</strong></label><input class="form-control text-size" type="text" placeholder="Isi Alamat..." name="alamat" id="nip"></div>
                                                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#submit').submit(function(e){
            ...
            var nama_lengkap=document.forms["submit"]["nama_lengkap"].value;
