...
<script src="http://cdn.datatables.net/1.10.12/js/jquery.dataTables.min.js"></script>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-1" id="dataTable" role="grid" aria-describedby="dataTable_info" style="font-size: 13px;">
                            <table class="table table-hover dataTable my-0" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($row->foto) { ?><img class="rounded-circle mr-2" width="30" height="30" src="<?php echo base_url(); ?>assets/images/<?php echo $row->foto; ?>"> <?php } ?>
                                        <?php echo $row->nama_lengkap; ?>
                                        </td>
                                        <td><?php echo $row->fraksi; ?></td>
                                        ...
                                        data-id_jabatan="<?php echo $row->id_jabatan; ?>^<?php echo $row->jabatan_dewan; ?>"
                                                    ...
                                                    <div class="card shadow mb-3">
                                                        ...
                                                        <div class="card-body">
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col-xl-12">
                                                                        <div class="form-group"><label for="email"><strong>Jabatan</strong></label><select class="form-control form-control-sm text-size" name="jabatan" id="jabatan">
                                                                               
                                                                    <?php foreach($jabatan as $ros):?>
                                                                      <option value="<?php echo $ros->id; ?>^<?php echo $ros->nama_jabatan; ?>"><?php echo $ros->nama_jabatan; ?></option>
                                                                    <?php endforeach; ?>
                                                                      <!--
                                                                            <option value="Ketua">Ketua</option><option value="Wakil Ketua">Wakil Ketua</option><option value="Anggota">Anggota</option>
                                                                        -->
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="card shadow">
                                                        ...
                                                        <div class="form-row">
                                                                ...
                                                                <div class="col-xl-12">
                                                                    <div class="form-group"><label for="first_name"><strong>Nama Lengkap</strong></label><input class="form-control form-control-sm text-size nama_lengkap" type="text" placeholder="Isi Nama Lengkap..." name="namaLengkap" id="namaLengkap"></div>
                                                                </div>
                                                                
                                                                <div class="col-xl-12">
                                                                    <div class="form-group"><label for="first_name"><strong>NIP</strong></label><input class="form-control form-control-sm text-size nip" type="text" placeholder="Isi NIP..." name="nip" id="nip"></div>
                                                                </div>
                                                    ...
                                                    <div class="card shadow mb-3">
                                                        ...
                                                        <div class="card-body">
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col-xl-12">
                                                                        <div class="form-group"><label for="email"><strong>Jabatan</strong></label><select class="form-control form-control-sm text-size jabatan" name="jabatan">

                                                                              <?php foreach($jabatan as $ros):?>
                                                                      <option value="<?php echo $ros->id; ?>^<?php echo $ros->nama_jabatan; ?>"><?php echo $ros->nama_jabatan; ?></option>
                                                                    <?php endforeach; ?>
<!--
                                                                            <option value="undefined" selected="">Pilh Jabatan...</option><option value="Ketua">Ketua</option><option value="Wakil Ketua">Wakil Ketua</option><option value="Anggota">Anggota</option>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#submit').submit(function(e){
            ...
            var namaLengkap=document.forms["submit"]["namaLengkap"].value;
            var nip=document.forms["submit"]["nip"].value;
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#edit_dewan').submit(function(e){
            ...
            var nama_lengkap=document.forms["edit_dewan"]["namaLengkap"].value;
            var nip=document.forms["edit_dewan"]["nip"].value;
          ...
          return false;
          }else if (namaDepan==null || namaDepan=="")
          {
           swal({
                title: "Peringatan!",
                text: "Nama depan tidak boleh kosong!"
