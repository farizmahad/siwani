                                ...
                                <div class="card shadow mb-3 text-size">
                                    ...
                                    <div class="card-body">
                                          <form autocomplete="off" method="POST" action="<?php echo base_url(); ?>usulan/save_usulan" enctype="multipart/form-data" id="myform" onSubmit="return validasi()">
                                            <div class="form-row">
                                                 <div class="col-xl-12">
                                                    <div class="form-group"><label for="username" class="text-primary"><strong>Reses Ke- ...</strong></label><select class="form-control form-control-sm text-size" name="reses" id="reses"
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="form-group"><label for="username" class="text-primary"><strong>Nama Anggota DPRD</strong></label>
                                                        <div class="autocomplete">
                                                         ...
                                                         <?php }else{ ?>
                                                                    <input class="form-control form-control-sm text-size" type="text" name="namaAnggota" value="<?php echo $nama_lengkap; ?>" readonly>
                                                         <?php } ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-xl-12">
                                                    <div class="form-group"><label for="username" class="text-primary"><strong>Fraksi</strong></label>
                                                        <div class="autocomplete">
                                                                <?php
                                                               $group2=array('operator');
                                                                   if($this->ion_auth->in_group($group2)){ ?>
                                                ...
                                                <div class="col-lg-6 col-xl-6">
                                                    <div class="form-group"><label for="username" class="text-primary"><strong>Dapil</strong></label>
                                                        <div>
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group"><label for="username" class="text-primary"><strong>Tanggal Pelaksanaan</strong></label><input class="form-control form-control-sm text-size" type="date" name="tgl" id="tgl" onchange="return cekHari()"></div>
                                                </div>
                                                 <div class="col-xl-2">
                                                    <div class="form-group"><label for="username" class="text-primary"><strong>Hari</strong></label><input class="form-control form-control-sm text-size" type="text" name="hari" id="hari" readonly=""></div>
                                                </div>
												
												<!-- Input Tambahan: TEMPAT, format: VARCHAR-->
												<div class="col-xl-12">
                                                    <div class="form-group"><label class="text-primary" for="username"><strong>Tempat</strong></label><input class="form-control form-control-sm text-size" type="text" name="tempat" placeholder="Isi Tempat..." id="tempat"></div>
                                                </div>
												
												<!-- Input Tambahan: waktu, format: VARCHAR-->
												<div class="col-xl-12">
                                                    <div class="form-group"><label class="text-primary" for="username"><strong>Waktu (WIB)</strong></label><input class="form-control form-control-sm text-size" type="text" name="waktu" placeholder="Isi Waktu..." id="waktu"></div>
                                                </div>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="form-group"><label class="text-primary" for="username"><strong>Snack Box</strong></label><textarea class="form-control form-control-sm text-size" placeholder="Isi Jumlah Snack..." rows="2" name="snack"></textarea></div>
                                                </div>
												 <div class="col-xl-6">
                                                    <div class="form-group"><label class="text-primary" for="username"><strong>Nasi Box</strong></label><textarea class="form-control form-control-sm text-size" placeholder="Isi Jumlah Porsi Nasi Box..." rows="2" name="makanan"></textarea></div>
                                                </div>
												
												<!--Input Tambahan: Kursi-->
												<div class="col-xl-6">
                                                    <div class="form-group"><label class="text-primary" for="username"><strong>Kursi</strong></label><textarea class="form-control form-control-sm text-size" placeholder="Isi Jumlah Kursi..." rows="2" name="kursi"></textarea></div>
                                                </div>
												
												<!--Perubahan Tampilan Input-->
                                                <div class="col-xl-6">
                                                    <div class="form-group"><label class="text-primary" for="username"><strong></strong></label>
														<div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-1" name="spanduk" value="Ya"><label class="form-check-label text-primary" for="formCheck-1"><strong>Spanduk</strong></label></div>
														<div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-1" name="tenda" value="Ya"><label class="form-check-label text-primary" for="formCheck-1"><strong>Tenda</strong></label></div>
														<div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-1" name="sound" value="Ya"><label class="form-check-label text-primary" for="formCheck-1"><strong>Sound</strong></label></div>
													</div>
                                                </div>
 ...
 function validasiFile(){
  ...
  <script>
    ...
    function validasi()
    {
       ...
       var id_pendamping=document.forms["myform"]["id_pendamping"].value;
  ...
  if (tempat==null || tempat=="")
        ...
        if (jumlah_konsituen==null || jumlah_konsituen=="")
          ...
          return false;
           ...
           if (id_pendamping==null || id_pendamping=="")
          {
           swal({
                title: "Peringatan!",
                text: "Pendamping tidak boleh kosong!"
            });
          return false;
          };
