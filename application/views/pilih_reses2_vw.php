                            ...
                            <div class="card-header py-3">
                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="id_bidang" value="<?php echo $id_bidang; ?>" id="id_bidang;">
                                        <div
                                    ...
                                    <div class="col-xl-1"><button class="btn btn-primary btn-block btn-sm text-size" type="submit" id="submit_search">Go!</button></div>

                                    </form>
                                   -->

                                   <form <?php /*id="form_search"*/?> method="GET" action="<?php echo base_url(); ?>Export/view_excel">
                                    <div class="row">
                                        <div class="col-xl-2"><select class="custom-select custom-select-sm text-size mr-2" name="pilihan" id="pilihan"><option value="">Cetak berdasarkan</option>
                                            <option value="dewan">Anggota Dewan</option>
                                            <option value="reses1">Reses 1</option>
                                        ...
                                        <div
                                            class="col-xl-2"><input class="form-control-sm text-size mr-2" type="text" placeholder="Isi Parameter..." name="parameter" id="parameter"></div>
                                    <div class="col-xl-2"><button class="btn btn-primary btn-block btn-sm text-size" type="submit" id="submit_search">Cetak</button></div>
                                   ...
                                   <!--
                                    <div class="col-xl-2">
                                       <a href="<?php echo base_url(); ?>Export/export_bidang?bidang=<?php echo $bidang; ?>&pilihan=<?php echo $pilihan; ?>&parameter=<?php echo $parameter; ?>" type="button" class="btn btn-primary btn-block btn-sm text-size">Unduh </a>
                                       </div>
                                   -->
                                </div>
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-7 col-md-6 col-lg-4 col-xl-4"><input class="form-control-sm form-control text-size mb-2" type="text" id="myInput3" placeholder="Cari..."></div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <?php } ?>
                                            ...
                                            */?>
                                            ...
                                            data-id_pendamping="<?php echo $row->id_pendamping; ?>"
                                            ...
                                            <?php }else{ ?>
                                                ...
                                                <button class="btn btn-success btn-sm text-size ubah_button" type="button" data-toggle="modal" data-target="#editModal"
                                            data-id="<?php echo $row->id; ?>">
                                            <i class="fas fa-edit"></i></button>
...
<div class="modal fade" role="dialog" tabindex="-1" id="lihatModal">
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="editModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content" id="edit_reses">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="text-size" autocomplete="off" id="simpan_bidang">
                        <div class="form-row">
                            <div class="col-xl-12">
                                 <div class="form-group"><label class="text-primary" for="username"><strong>Reses Ke- ...</strong></label><input class="form-control form-control-sm text-size reses" type="text" id="reses" name="reses" readonly=""> <!--<select class="form-control form-control-sm text-size reses" id="reses" name="reses" readonly><option value="">Pilih Reses...</option><option value="1">Reses 1</option><option value="2">Reses 2</option><option value="3">Reses 3</option></select>--> </div>
                            </div>
                            <div class="col-xl-12">
                              <div class="form-group"><label class="text-primary" for="username"><strong>Nama Anggota Dewan</strong></label>
                                    <div class="autocomplete"><input class="form-control form-control-sm text-size nama_lengkap" type="text" id="myInput" name="namaAnggota" placeholder="Isi Nama Anggota Dewan..." onmouseover="autofill();" autofocus="on" readonly=""></div>
                                </div>
                            </div>
                            <div class="col-xl-12">
                            ...
                            <div class="col-xl-4">
                                <div class="form-group"><label class="text-primary" for="username"><strong>Tanggal Pelaksanaan</strong></label><input class="form-control form-control-sm text-size tanggal" type="date" name="tgl" readonly="">

                                </div>

                            </div>
                            <div class="col-xl-2">
                                <div class="form-group"><label class="text-primary" for="username"><strong>Hari</strong></label><input class="form-control form-control-sm text-size hari" type="hari" name="hari" readonly="">

                                </div>

                            </div>
                            <div class="col-xl-12">
                                <div class="form-group"><label class="text-primary" for="username"><strong>Nama Pengusul</strong></label><textarea class="form-control form-control-sm text-size nama" placeholder="Isi Nama Pengusul..." rows="2" name="nama" id="nama"></textarea></div>
                            </div>
                            <div class="col-xl-12">
                                <div class="form-group"><label class="text-primary" for="username"><strong>Alamat Pengusul</strong></label><textarea class="form-control form-control-sm text-size alamat" placeholder="Isi Alamat Pengusul..." rows="2" name="alamat" id="alamat"></textarea></div>
                            </div>
                            <input type="hidden" name="id" class="id">
                            <div class="col-xl-12">
                                <div class="form-group"><label class="text-primary" for="username"><strong>Pembidangan</strong></label><select class="form-control form-control-sm text-size bidang" name="bidang" id="bidang"><option value="">Pilih Bidang...</option><option value="Bidang Pemerintahan">Bidang Pemerintahan</option><option value="Bidang Ekonomi Keuangan">Bidang Ekonomi Keuangan</option><option value="Bidang Pembangunan">Bidang Pembangunan</option><option value="Bidang Kesejahteraan Rakyat">Bidang Kesejahteraan Rakyat</option></select></div>
                            </div>
                            <div class="col-xl-12">
                                <div class="form-group"><label class="text-primary" for="username"><strong>Usulan Aspirasi</strong></label><textarea class="form-control form-control-sm text-size kesimpulan" placeholder="Isi Aspirasi..." rows="9" name="aspirasi" id="aspirasi"></textarea></div>
                            </div>

                             <div class="col-xl-12">
                                <div class="form-group"><label class="text-primary" for="username"><strong>Volume</strong></label><input class="form-control form-control-sm text-size volume" type="text" name="volume" placeholder="Volume"></div>

                            </div>
                            <div class="col-xl-12">
                                <div class="form-group"><label class="text-primary" for="username"><strong>Lokasi</strong></label><input class="form-control form-control-sm text-size lokasi" type="text" name="lokasi" placeholder="Lokasi"></div>
...
<script>
 ...
 <script>
    ...
    */
     ...
     var id_pendamping   = $(this).data('id_pendamping');
  ...
  $(".tanda").val(tanda);
     ...
     $(".tempat").val(tempat);
     $(".waktu").val(waktu);
     $(".id_pendamping").val(id_pendamping);
     $(".hari").val(hari);
...
<script>
    $(document).on("click", ".ubah_button", function () {
        var myId = $(this).data('id');
        var tanda = $(this).data('tanda');
        
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>Proposal/ubah_proposal',
            data: { ids: myId,tanda: tanda},
            success: function(response) {
                $('#edit_reses').html(response);
            }
        });
    });  
</script>
...
$(document).ready(function() {
                   ...
                   $("#submit_search").click(function(){
                    var pilihan=document.forms["form_search"]["pilihan"].value;
                    var parameter=document.forms["form_search"]["parameter"].value;
                    var id_bidang=document.forms["form_search"]["id_bidang"].value;
                    var hasil="hasil";


                     $('#result').load("<?php echo base_url() ?>Proposal/reses_proposal/"+id_bidang+"/"+hasil+"/"+pilihan+"/"+parameter);
