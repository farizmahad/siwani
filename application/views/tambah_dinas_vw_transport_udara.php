                                                        ...
                                                        <div class="card-body">
                                                            <div>
                                                                ...
                                                                for ($i = 0; $i < $jumlah_peserta; $i++){ ?>
                                                                    <h3 align="center">Peserta ke <?php echo $i+1; ?></h3>
                                                                    <hr>
                                                                <div class="form-row">
                                                                ...
                                                                <?php endforeach; ?>
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        ...
                                                                        <input class="form-control form-control-sm text-size tglBerangkatUdara<?php echo $i+1; ?>" type="date" name="tglBerangkatUdara[]"  id="tglBerangkatUdara" onchange="hitung_durasi()"></div>
                                                                    </div>
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Harga Tiket</strong></label>
                                                                        <input class="form-control form-control-sm text-size" type="text" name="hargaTiketUdara[]" placeholder="Isi Harga Tiket..." id="hargaTiketUdara"></div>
                                                                    </div>
                                                                    <div class="col-xl-12 text-success mt-3">
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>No. Tiket</strong></label><input class="form-control form-control-sm text-size" type="text" placeholder="Isi No. Tiket..." name="noTiketMaskapai2[]"
                                                                                id="noTiketMaskapai2[]"></div>
                                                                    </div>
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Asal</strong></label><input class="form-control form-control-sm text-size" type="text" placeholder="Isi Asal..." name="asalUdara2[]" id="asalUdara2"></div>
                                                                    </div>
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Tujuan</strong></label><input class="form-control form-control-sm text-size" type="text" placeholder="Isi Tujuan..." name="tujuanUdara2[]" id="tujuanUdara2"></div>
                                                                    </div>
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Tanggal Kembali</strong></label><input class="form-control form-control-sm text-size tglKembaliUdara<?php echo $i+1; ?>" type="date" name="tglKembaliUdara[]" id="tglKembaliUdara" onchange="alert_tanggal()"></div>
                                                                    </div>
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Harga Tiket</strong></label><input class="form-control form-control-sm text-size" type="text" name="hargaTiketUdara2[]" placeholder="Isi Harga Tiket..." id="hargaTiketUdara2"></div>
                                                                    </div>
                                                                    <div class="col-xl-12 bg-primary mb-3">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Jumlah Hari</strong></label><input class="form-control form-control-sm text-size jumlahHariUangHarian<?php echo $i+1; ?>" type="number" min="0" name="jumlahHariUangHarian[]" placeholder="Isi Jumlah Hari..."></div>
                                                                    </div>
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Rate</strong></label><input class="form-control form-control-sm text-size" type="number" min="0" name="rateUangHarian[]" placeholder="Isi Rate..."></div>
                                                                    </div>
                                                                    <!--
                                                                    <div class="col-xl-6">
                                                                ...
                                                                -->
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Jumlah Hari</strong></label><input class="form-control form-control-sm text-size jumlahHariUangSaku<?php echo $i+1; ?>" type="number" min="0" name="jumlahHariUangSaku[]" placeholder="Isi Jumlah Hari..."></div>
                                                                    </div>
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Rate</strong></label><input class="form-control form-control-sm text-size" type="number" min="0" name="rateUangSaku[]" placeholder="Isi Rate..."></div>
                                                                    </div>
                                                                    <!--
                                                                    <div class="col-xl-6">
                                                                ...
                                                                -->
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Check-in</strong></label><input class="form-control form-control-sm text-size checkInUdara<?php echo $i+1; ?>" type="date" name="checkInUdara[]" onchange="sum();"></div>
                                                                    </div>
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Check-Out</strong></label><input class="form-control form-control-sm text-size checkOutUdara<?php echo $i+1; ?>" type="date" name="checkOutUdara[]" onchange="sum();"></div>
                                                                    </div>
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Jumlah Hari / Paket</strong></label><input class="form-control form-control-sm text-size hariUdara<?php echo $i+1; ?>" type="number" name="hariUdara[]" min="0" placeholder="Isi Jumlah Hari / Paket..." readonly=""></div>
                                                                    </div>
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Rate</strong></label><input class="form-control form-control-sm text-size" type="number" name="rateHotelUdara[]" min="0" placeholder="Isi Rate..."></div>
                                                                    </div>
                                                                    <!--
                                                                    <div class="col-xl-6">
                                                                ...
                                                                -->
                                                                    <div class="col-xl-12 mt-3">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Uang Representasi</strong></label><input class="form-control form-control-sm text-size" type="number" name="uangRepresentasiUdara[]" min="0"
                                                                                placeholder="Isi Uang Representasi..."></div>
                                                                    </div>
                                                                    <div class="col-xl-6 mt-3">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Transport Lokal (Keberangkatan)</strong></label><input class="form-control form-control-sm text-size" type="number" name="uangTransportLokal1[]"
                                                                                min="0" placeholder="Isi Transport Lokal..."></div>
                                                                    </div>
                                                                    <div class="col-xl-6 mt-3">
                                                                    ...
                                                                    <div class="col-xl-6 mt-3">
                                                                        <div class="form-group"><label class="text-primary text-size"><strong>Transport Bandara (Keberangkatan)</strong></label><input class="form-control form-control-sm text-size" type="number" name="uangTransportBandara1[]"
                                                                                min="0" placeholder="Isi Transport Hotel..."></div>
                                                                    </div>
                                                                    <div class="col-xl-6 mt-3">
