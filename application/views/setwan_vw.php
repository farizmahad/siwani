...
<script src="https://pagination.js.org/dist/2.1.4/pagination.js"></script>
 ...
 <script src="<?php echo base_url(); ?>assets/plugins/js/sweetalert/sweetalert.min.js"></script>
					<div class="card-header py-3">
                        <h6><strong>Daftar Anggota Setwan</strong></h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                              <!--
                            <div class="col-md-6 col-xl-2 text-nowrap">
                              ...
                              -->
                            <div class="col-md-6 col-xl-5 text-nowrap"><button class="btn btn-primary btn-sm text-size" type="button" data-toggle="modal" data-target="#addmodalDapil"><i class="fas fa-plus-circle"></i>&nbsp; Tambah Anggota Setwan</div>
                        ...
                        <div class="table-responsive table mt-1" id="dataTable" role="grid" aria-describedby="dataTable_info" style="font-size: 15px;">
                            <table class="table table-hover" id="myTable">
                                ...
                                <tbody>
                                    <?php 
                                    $count_setwan=count($setwan);
                                    if($count_setwan>0) {
                                    $no=1;
                                    foreach($setwan as $row):?>
                                    <tr>
                                        ...
                                        data-id_jabatan="<?php echo $row->id_jabatan; ?>^<?php echo $row->jabatan; ?>"
                        ...
                        <div class="col-xl-12">
                            <div class="text-nowrap modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title"><strong>Tambah Anggota Setwan</strong></h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></div>
                                <div class="modal-body text-size">
                                        ...
                                        <div class="col-xl-12">
                                                ...
                                                <select class="form-control" name="jabatan">
                                                    ...
                                                    <?php foreach($jabatan as $row):?>
                                                            ...
                                                            <option value="<?php echo $row->id; ?>^<?php echo $row->nama_jabatan; ?>"><?php echo $row->nama_jabatan; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
									...
									<div class="row">
                                        <div class="col-xl-12">
                                                ...
                                                <div class="form-group"><label>Golongan</label><input class="form-control text-size" type="text" placeholder="Golongan" id="golongan" name="golongan"></div>
                                                
                                          
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer"><button class="btn btn-light btn-sm border rounded-0 text-size" type="button" data-dismiss="modal">Tutup</button><button class="btn btn-primary btn-sm text-size" type="button" id="submit_tambah_setwan">Simpan</button></div>
                            </div>
                        </div>
                    </div>
   ...
   <div class="modal fade" role="dialog" tabindex="-1" id="editmodalDapil">
                    ...
                    <div class="row">
                      <form id="edit_setwan">
                        ...
                        <div class="col-xl-12">
                            <div class="text-nowrap modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"><strong>Edit Anggota Setwan</strong></h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></div>
                                <div class="modal-body text-size">
                                    <div class="row">
                                        <div class="col-xl-12">
									...
									<div class="row">
                                        <div class="col-xl-12">
                                                ...
                                                <div class="form-group"><label>Golongan</label><input class="form-control text-size golongan" type="text" placeholder="Golongan" id="golongan" name="golongan"></div>
                                ...
                                <div class="modal-footer"><button class="btn btn-light btn-sm border rounded-0 text-size" type="button" data-dismiss="modal">Tutup</button><button class="btn btn-success btn-sm text-size" type="submit" id="submit_edit_setwan">Edit</button></div>
                            </div>
                        </div>
                    </div>
                  </form>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="hapusmodalDapil">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
              <form id="hapus_setwan">
                <div class="modal-header">
                    <h5 class="modal-title"><strong>Hapus Data Anggota Setwan</strong></h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></div>
                <div class="modal-body">
                    <p>Anda yakin akan menghapus data ini?</p>
                    <input type="hidden" name="id" class="id">
                </div>
                <div class="modal-footer"><button class="btn btn-light btn-sm text-size" type="button" data-dismiss="modal">Tutup</button><button class="btn btn-danger btn-sm text-size" type="submit" id="submit_hapus_setwan">Hapus!</button></div>
            </div>
          </form>
        </div>
    </div>
...
$(document).on( "click", '.hapus_button',function(e) {
   ...
   $(document).ready(function() {
                   ...
                   $("#submit_tambah_setwan").click(function(){
                    var nama=document.forms["form_tambah_setwan"]["nama"].value;
                    var nip=document.forms["form_tambah_setwan"]["nip"].value;
                    var jabatan=document.forms["form_tambah_setwan"]["jabatan"].value;
                    var golongan=document.forms["form_tambah_setwan"]["golongan"].value;
          ...
          return false;
          }else if (golongan==null || golongan=="")
          {
           swal({
                title: "Peringatan!",
                text: "Golongan tidak boleh kosong!"
            });
          return false;
          }
                         ...
                         $.ajax({
                           ...
                           url : "<?php echo base_url(); ?>Master/save_setwan", 
                           type: "POST", 
                           dataType:'json',
                          data:{nama,nip,jabatan,golongan},
                             success: function(hasil) {
                           ...
                           if(hasil.pesan==''){
                             ...
                             */
                             alert('Data berhasil ditambah');
                              $('#result').load("<?php echo base_url() ?>Master/detail_master/setwan");
                            }
                            }
                         });
                 ...
                 return false;
                     ...
                     //untuk simpan barang     
                    $("#submit_edit_setwan").click(function(){

             var nama=document.forms["edit_setwan"]["nama"].value;
             var nip=document.forms["edit_setwan"]["nip"].value;
             var jabatan=document.forms["edit_setwan"]["jabatan"].value;
             var golongan=document.forms["edit_setwan"]["golongan"].value;
          ...
          return false;
			...
			return false;
                         ...
                         $.ajax({
                           ...
                           type: "POST", 
                           dataType:'json',
                           data: $("#edit_setwan").serialize(),
                             success: function(data) {
                              console.log(data);
                             $("#pesan_setwan").html(data.pesan);
                             if(data.pesan==''){
                 ...
                 return false;
                        ...
                        $("#submit_hapus_setwan").click(function(){

                         $.ajax({

                           
                           url : "<?php echo base_url(); ?>Master/delete_setwan", 
                           type: "POST", 
                           data: $("#hapus_setwan").serialize(),
                             success: function(data) {
